...
import { LanguageEntityM } from './language.entity';
...
class UserLanguageProperty {
  ...
  @Prop({ required: true, type: mongoose.Types.ObjectId, ref: LanguageEntityM.name })
  language: LanguageEntityM;
}
...
export type UserDocument = HydratedDocument<UserEntityM>;
export const UserSchema = SchemaFactory.createForClass(UserEntityM);
